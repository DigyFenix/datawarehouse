...
-- Impacto   : bajo; tabla nueva + carga inicial de Grupo Cresta (10 NIT).
-- Idempotente: sí.
...
-- 2) Carga inicial de Grupo Cresta (solicitud 2026-08-02). Idempotente: la
--    unicidad por (organización, normalizado) hace que repetir no duplique.
