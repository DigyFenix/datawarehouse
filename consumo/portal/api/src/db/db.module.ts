...
import { LectorPoolsService } from './lector-pools.service';
...
@Global()
@Module({
  providers: [ControlDbService, TenantPoolsService, LectorPoolsService],
  exports: [ControlDbService, TenantPoolsService, LectorPoolsService],
})
