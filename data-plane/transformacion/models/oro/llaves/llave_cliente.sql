{#
  Mapa de llaves sustitutas de `cliente`: (llave natural del ERP → entero autoincremental).
...
{{ mapa_llaves(ref('plata_socio_negocio'), ['empresa_id', 'socio_codigo'], filtro='es_cliente') }}
